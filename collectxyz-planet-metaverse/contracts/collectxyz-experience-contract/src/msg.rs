...
use collectxyz_experience::{XyzExperience, Logo, MinterResponse};
use schemars::JsonSchema;
use serde::{Deserialize, Serialize};

pub use collectxyz_experience::CollectXyzExperienceExecuteMsg as ExecuteMsg;
...
pub struct InstantiateMsg {
    ...
    pub symbol: String,
    pub decimals: u8,
    pub initial_balances: Vec<XyzExperience>,
...
impl InstantiateMsg {
    pub fn get_caps(&self, sender: String) -> Option<Uint128> {
