...
const useXyzQuestResourceAllowance = (name: string, contractAddress: string) => { // TODO
  ...
  unknown,
  AllowanceResponse | undefined
  >(['questResourceAllowance', name, contractAddress], query, {
...
export default useXyzQuestResourceAllowance
